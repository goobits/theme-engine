 ...
 * ```
 */
export declare function createMockThemeStore(options?: MockThemeStoreOptions): ThemeStore;
/**
 ...
 * ```
 */
export declare function createMockConfig(options?: MockConfigOptions): ThemeConfig;
/**
 ...
 * ```
 */
export declare function mockBrowserEnvironment(isBrowser: boolean): Promise<void>;
/**
 ...
 * ```
 */
export declare function mockMatchMedia(prefersDark: boolean): void;
/**
 ...
 * ```
 */
export declare function mockDocumentCookie(cookieString: string): void;
/**
 * Reset all DOM mocks.
 *
 ...
 * ```
 */
export declare function resetDOMMocks(): void;
