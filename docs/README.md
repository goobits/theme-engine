...
1. Read [Custom Themes](./custom-themes.md) - Create your color schemes
2. Reference [Design Tokens](./design-tokens.md) - Available CSS variables
3. Check [API Reference](./api-reference.md) - Configuration options

### For Advanced Users

1. Study [API Reference](./api-reference.md) - Deep dive into all modules
2. Review [Best Practices](./best-practices.md) - Advanced patterns
3. Consult [Troubleshooting](./troubleshooting.md) - Debug complex issues
