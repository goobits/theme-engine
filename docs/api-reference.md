...
<ThemeProvider {config} serverPreferences={serverPrefs}>
    <!-- Your app -->
</ThemeProvider>
```
...
// Svelte types
import type { ThemeStore, ThemeSettings } from '@goobits/themes/svelte';

// Utils types
import type { RouteThemeConfig, UserPreferences } from '@goobits/themes/utils';
```
...
```typescript
import { applyThemeScheme, applyFullTheme, getCurrentScheme } from '@goobits/themes/core';
